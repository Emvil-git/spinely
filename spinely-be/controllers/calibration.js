...
const createCalibrationData = async (req, res, next) => {
    ...
    let query = `INSERT INTO device_calibration (userId, cervical_min_angle, cervical_max_angle, cervical_avg_angle, thoracic_min_angle, thoracic_max_angle,  thoracic_avg_angle, lumbar_min_angle, lumbar_max_angle, lumbar_avg_angle, left_midAxLine_min_angle, left_midAxLine_max_angle, left_midAxLine_avg_angle, right_midAxLine_min_angle, right_midAxLine_max_angle,  right_midAxLine_avg_angle,  calibration_timestamp) VALUES (${userId}, ${cervical_min_angle}, ${cervical_max_angle}, ${cervical_avg_angle}, ${thoracic_min_angle}, ${thoracic_max_angle}, ${thoracic_avg_angle}, ${lumbar_min_angle}, ${lumbar_max_angle}, ${lumbar_avg_angle}, ${left_midAxLine_min_angle}, ${left_midAxLine_max_angle}, ${left_midAxLine_avg_angle}, ${right_midAxLine_min_angle}, ${right_midAxLine_max_angle}, ${right_midAxLine_avg_angle}, '${calibration_timestamp}')`;
...
const updateCalibrationData = async (req, res, next) => {
    ...
    let query = `UPDATE device_calibration SET userId="${userId}", cervical_min_angle=${cervical_min_angle}, cervical_max_angle=${cervical_max_angle}, cervical_avg_angle=${cervical_avg_angle}, thoracic_min_angle=${thoracic_min_angle}, thoracic_max_angle=${thoracic_max_angle}, thoracic_avg_angle=${thoracic_avg_angle}, lumbar_min_angle=${lumbar_min_angle}, lumbar_max_angle=${lumbar_max_angle}, lumbar_avg_angle=${lumbar_avg_angle}, left_midAxLine_min_angle=${left_midAxLine_min_angle}, left_midAxLine_max_angle=${left_midAxLine_max_angle}, left_midAxLine_avg_angle=${left_midAxLine_avg_angle}, right_midAxLine_min_angle=${right_midAxLine_min_angle}, right_midAxLine_max_angle=${right_midAxLine_max_angle}, right_midAxLine_avg_angle=${right_midAxLine_avg_angle},  calibration_timestamp=${calibration_timestamp}) WHERE userId = ${userId}`;
